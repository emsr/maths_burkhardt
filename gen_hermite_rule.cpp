...
//
{
  ...
  timestamp ( );
  std::cout << "\n";
  std::cout << "GEN_HERMITE_RULE\n";
  std::cout << "  C++ version\n";
  std::cout << "\n";
  std::cout << "  Compiled on " << __DATE__ << " at " << __TIME__ << ".\n";
  std::cout << "\n";
  std::cout << "  Compute a generalized Gauss-Hermite rule for approximating\n";
  std::cout << "\n";
  std::cout << "    Integral ( -oo < x < +oo ) |x-a|^ALPHA exp ( - b * ( x - a )^2 ) f(x) dx\n";
  std::cout << "\n";
  std::cout << "  of order ORDER and parameter ALPHA.\n";
  std::cout << "\n";
  std::cout << "  The user specifies ORDER, ALPHA, A, B, and FILENAME.\n";
  std::cout << "\n";
  std::cout << "  ORDER is the number of points.\n";
  std::cout << "\n";
  std::cout << "  ALPHA is the exponent of |x|.\n";
  std::cout << "\n";
  std::cout << "  A is the center point:\n";
  std::cout << "\n";
  std::cout << "  B is a scale factor;\n";
  std::cout << "\n";
...
//
  ...
  {
    std::cout << "\n";
    std::cout << "  Enter the value of ALPHA (greater than -1.0)\n";
    cin >> alpha;
  }
//
//  Get A.
